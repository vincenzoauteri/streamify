...
socket.on('message', function(message) {
    ...
    var myResponse= prompt('Insert response to other peer:', "");
...
socket.on('Bye', function() {
    console.log('Got Bye from other Peer. Disconnecting');
